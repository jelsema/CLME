...
#'  \code{node}, and \code{descending}. See Figure 1 from Jelsema and Peddada (2016); the 
...
#' \item{\code{theta0}}{ estimates of \eqn{\theta_0}{theta_0} coefficients under the null hypothesis}
